...
var ScrollContainer = function (_React$Component) {
  ...
  function ScrollContainer(props, context) {
    ...
    _this.shouldUpdateScroll = function (prevRouterProps, routerProps) {
      var shouldUpdateScroll = _this.props.shouldUpdateScroll || _this.context.scrollBehavior.shouldUpdateScroll;

      if (!shouldUpdateScroll) {
        return true;
      }

      return shouldUpdateScroll.call(_this.context.scrollBehavior.scrollBehavior, _this.props.shouldUpdateScroll ? prevRouterProps : _this.context.scrollBehavior.state.prevRouterProps, _this.props.shouldUpdateScroll ? routerProps : _this.context.scrollBehavior.state.currentRouterProps);
    };
